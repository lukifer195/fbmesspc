        ...
        for entry in data["entry"]:
            for messaging_event in entry["messaging"]:
                ...
                if messaging_event.get("message"):  # someone sent us a message
                    ...
                    log("<>\n Receive message  o>>> {sender_id}  :  {message_text}".format(sender_id=sender_id, message_text=message_text))
...
def send_message(recipient_id, message_text):
    ...
    log("<>\n Sending message  o>>> {recipient}   :   {text}".format(recipient=recipient_id, text=message_text))
